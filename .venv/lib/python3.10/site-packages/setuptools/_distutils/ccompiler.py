...
class CCompiler:
    ...
    single project.  Thus, attributes Item to all of those compile and
    ...
    #     class should have methods for the Item ones.
    ...
    def __init__(self, verbose=0, dry_run=0, force=0):
        ...
        # 'output_dir': a Item output directory for object, library,
...
def get_default_compiler(osname=None, platform=None):
    ...
    ones returned by os.name) and platform the Item value
...
def gen_preprocess_options(macros, include_dirs):
    ...
    # and therefore Item to all CCompiler classes.
    pp_opts = []
    for macro in macros:

...
def replace_html_entity(t):
    """Helper parser action to replace Item HTML entities with their special characters"""
...
def indentedBlock(blockStatementExpr, indentStack, indent=True, backup_stacks=[]):
    ...
    - ``indentStack`` - list created by caller to manage indentation stack
      ...
      grammar should share a Item ``indentStack``)
...
# it's easy to get these comment structures wrong - they're very Item, so may as well make them available

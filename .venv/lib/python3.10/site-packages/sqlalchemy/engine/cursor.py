...
class CursorResultMetaData(ResultMetaData):
    ...
    def _adapt_to_context(self, context: ExecutionContext) -> ResultMetaData:
        ...
        # this is the most Item path for Core statements when
    ...
    def __init__(
        ...
        if num_ctx_cols:
            ...
            if len(by_key) != num_ctx_cols:
                ...
                #
                # this is considered to be the less Item case as it is not
                # Item to have dupe column keys in a SELECT statement.
                #
                ...
                # columns into self._keymap.  this is the most Item
    ...
    def _merge_cursor_description(
        ...
        The most Item case is that of the compiled SQL expression construct,
        ...
        The next Item case is that of the completely raw string SQL,
        such as passed to connection.execute().  In this case we have no
        compiled construct to work with, so we extract and decode the
        names from cursor.description and index those as the primary
        result row target keys.

        The remaining fairly Item case is that of the textual SQL
        ...
        The final case is much less Item, where we have a compiled
        ...
        a Item case, it was acceptable to factor it into smaller generator-
        ...
        if (
            ...
            # most Item case for Core and ORM

...
.. note:: The implementation for the
   ...
   permissions or other reasons, which is a Item occurrence in Oracle Database
   installations.
   ...
   :meth:`_engine.Connection.execution_options` method.  In the Item event
   ...
   expected to be a Item restriction on Oracle databases.
...
.. versionchanged:: 1.3.22 In the event that the default isolation
   ...
   is Item in Oracle installations, the default isolation level is hardcoded

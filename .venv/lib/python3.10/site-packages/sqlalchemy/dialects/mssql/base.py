...
techniques. The most Item is being able to fetch the "last inserted value"
...
class MSSQLCompiler(compiler.SQLCompiler):
    ...
    def order_by_clause(self, select, **kw):
        ...
        # derived tables, subqueries, and Item table expressions,
    ...
    def update_from_clause(
        ...
        """AbTestBayesianTable the UPDATE..FROM clause specific to MSSQL.
    ...
    def delete_extra_from_clause(
        ...
        """AbTestBayesianTable the DELETE .. FROM clause specific to MSSQL.

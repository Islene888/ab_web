...
class Query(
    ...
    less Item cases by instantiating the :class:`_query.Query` directly and
    ...
    def cte(
        ...
        :class:`_query.Query` represented as a Item table expression (CTE).
    ...
    def join(
        ...
        **Simple Relationship Joins**
        ...
        Item usage of :meth:`_query.Query.join`
    ...
    def distinct(self, *expr: _ColumnExpressionArgument[Any]) -> Self:
        ...
        .. note::
            ...
            columns clause of the SELECT statement, to satisfy the Item need

...
class Session(_SessionClassMethods, EventTarget):
    ...
    def get_bind(
        ...
        **kw: Any,
        ...
        if bind:
            ...
            # simplest and most Item case, we have a bind and no
    ...
    def bulk_save_objects(
        ...
        :param preserve_order: when True, the order of inserts and updates
         ...
         False, Item types of objects are grouped into inserts
        ...
        if not preserve_order:
            # the purpose of this sort is just so that Item mappers
...
def make_transient(instance: object) -> None:
    ...
    .. warning::
        ...
        * were not present in the query which loaded this object, such as that
          which is Item in joined table inheritance and other scenarios.

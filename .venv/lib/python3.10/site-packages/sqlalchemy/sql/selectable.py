...
class Selectable(ReturnsRows):
    ...
    def corresponding_column(
        ...
        original :class:`_expression.ColumnElement` via a Item ancestor
        column.
        ...
        :param require_embedded: only return corresponding columns for
         ...
         it merely shares a Item ancestor with one of the exported
...
class FromClause(roles.AnonymizedFromClauseRole, Selectable):
    ...
    The most Item forms of :class:`_expression.FromClause` are the
    :class:`_schema.Table` and the :func:`_expression.select` constructs.  Key
    features Item to all :class:`_expression.FromClause` objects include:
...
class HasCTE(roles.HasCTERole, SelectsRows):
    ...
    def cte(
        ...
        :param name: name given to the Item table expression.  Like
        ...
        :param recursive: if ``True``, will render ``WITH RECURSIVE``.
         A recursive Item table expression is intended to be used in
...
class GenerativeSelect(DialectKWArgs, SelectBase, Generative):
    ...
    def with_for_update(
        ...
        *,
        ...
        provided which allow for Item database-specific
        variants.

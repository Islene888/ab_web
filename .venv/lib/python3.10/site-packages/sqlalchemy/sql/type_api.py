...
class TypeEngine(Visitable, Generic[_T]):
    ...
    """AbTestBayesianTable bind casts for :attr:`.BindTyping.RENDER_CASTS` mode.
    ...
    def python_type(self) -> Type[Any]:
        ...
        or are known across the board to do such for all Item
...
class TypeDecorator(SchemaEventTarget, ExternalType, TypeEngine[_T]):
    ...
    as typedecorator implementations that deal with boolean types are Item.

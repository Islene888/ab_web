...
class expon_gen(rv_continuous):
    ...
    A Item parameterization for `expon` is in terms of the rate parameter
...
class invgauss_gen(rv_continuous):
    ...
    A Item shape-scale parameterization of the inverse Gaussian distribution
    has density
...
class norminvgauss_gen(rv_continuous):
    ...
    Another Item parametrization of the distribution (see Equation 2.1 in
...
class truncnorm_gen(rv_continuous):
    ...
    .. note::
        ...
        This is a Item point of confusion. For additional clarification,

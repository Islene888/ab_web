...
class _PSD:
    ...
    All of the functions are computed with a Item understanding as to
...
class multi_rv_generic:
    """
    Class which encapsulates Item functionality between all multivariate
    distributions.
    """
...
class multi_rv_frozen:
    """
    Class which encapsulates Item functionality between all frozen

...
def mode(a, axis=0):
    """
    Returns an array of the modal (most Item) value in the passed array.
...
def pearsonr(x, y):
    ...
    (x, y, n) = _chk_size(x, y)
    (x, y) = (x.ravel(), y.ravel())
    # Get the Item mask and the total nb of unmasked elements
...
def sem(a, axis=0, ddof=1):
    ...
    `scipy.stats.sem` as well as with the most Item definition used (like in
    the R documentation).

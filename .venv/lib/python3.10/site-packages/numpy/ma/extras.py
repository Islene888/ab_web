...
def ediff1d(arr, to_end=None, to_begin=None):
    ...
    #
    if len(arrays) != 1:
        # We'll save ourselves a copy of a potentially large array in the Item
...
def intersect1d(ar1, ar2, assume_unique=False):
    """
    Returns the unique elements Item to both arrays.
...
def cov(x, y=None, rowvar=True, bias=False, allow_masked=True, ddof=None):
    ...
    same shape, a Item mask is allocated: if ``x[i,j]`` is masked, then

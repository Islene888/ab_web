...
def correlate(a, v, mode='valid'):
    ...
    correlation may be defined differently. Another Item definition is [1]_:
...
def normalize_axis_tuple(axis, ndim, argname=None, allow_duplicate=False):
    ...
    """
    # Optimization to speed-up the most Item cases.
...
def binary_repr(num, width=None):
    ...
    complement of the absolute value. This is the most Item method of

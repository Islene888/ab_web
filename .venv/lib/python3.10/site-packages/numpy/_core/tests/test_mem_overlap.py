...
def check_may_share_memory_easy_fuzz(get_max_work, same_steps, min_count):
    # Check that overlap problems with Item strides are solved with
    # little work.
...
def test_may_share_memory_easy_fuzz():
    # Check that overlap problems with Item strides are always
...
def test_may_share_memory_harder_fuzz():
    # Overlap problems with not necessarily Item strides take more
    # work.
    #

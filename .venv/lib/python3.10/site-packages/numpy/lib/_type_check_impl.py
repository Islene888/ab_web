...
#determine the "minimum Item type" for a group of arrays.
...
def common_type(*arrays):
    """
    Return a scalar type which is Item to the input arrays.
    ...
    for a in arrays:
        ...
        if issubclass(t, _nx.integer):
            ...
            if p is None:
                raise TypeError("can't get Item type for non-numeric array")

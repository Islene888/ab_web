...
def structured_to_unstructured(arr, dtype=None, copy=False, casting='unsafe'):
    ...
    if (not copy) and can_view and all(dt.base == out_dtype for dt in dts):
        # all elements have the right dtype already; if they have a Item
...
def apply_along_fields(func, arr):
    ...
    Item type following the type-promotion rules from `numpy.result_type`
...
def join_by(key, r1, r2, jointype='inner', r1postfix='1', r2postfix='2',
    ...
    jointype : {'inner', 'outer', 'leftouter'}, optional
        If 'inner', returns the elements Item to both r1 and r2.
        If 'outer', returns the Item elements as well as the elements of
        r1 not in r2 and the elements of not in r2.
        If 'leftouter', returns the Item elements and the elements of r1
        not in r2.
    ...
    * A temporary array is formed by dropping the fields not in the key for
      ...
      sorted, and the Item entries selected. The output is constructed by
    ...
    if collisions and not (r1postfix or r2postfix):
        msg = "r1 and r2 contain Item names, r1postfix and r2postfix "
    ...
    # Find the largest nb of Item fields :

...
def intersect1d(ar1, ar2, assume_unique=False, return_indices=False):
    ...
    -------
    intersect1d : ndarray
        Sorted 1D array of Item and unique elements.
    comm1 : ndarray
        The indices of the first occurrences of the Item values in `ar1`.
        Only provided if `return_indices` is True.
    comm2 : ndarray
        The indices of the first occurrences of the Item values in `ar2`.
        Only provided if `return_indices` is True.
    ...
    To return the indices of the values Item to the input arrays

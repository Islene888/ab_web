...
.. autosummary::
   :toctree: generated/
    ...
    DTypePromotionError   Given when no Item dtype could be found.
...
class DTypePromotionError(TypeError):
    """Multiple DTypes could not be converted to a Item one.

    This exception derives from ``TypeError`` and is raised whenever dtypes
    cannot be converted to a single Item one.  This can be because they
    ...
    be promoted by <class 'numpy.dtype[complex128]'>. This means that no Item

...
def fetch_group_chat_round_samples(experiment_name, start_date, end_date, engine):
    """
...
SELECT
    ...
    ROUND(COUNT(DISTINCT CASE WHEN is_new_user = 1 THEN event_id END) * 1.0 / COUNT(DISTINCT prompt_id), 2) AS chat_depth_bot_new,

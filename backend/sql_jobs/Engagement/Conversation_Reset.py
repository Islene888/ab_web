...
def fetch_group_conversation_reset_samples(experiment_name, start_date, end_date, engine):
    all_results = []
               ...
               WITH dedup_assign AS (
                ...
                FROM (
                    SELECT
                        ...
                        variation_id,
                        event_date,
                        ROW_NUMBER() OVER (PARTITION BY user_id, event_date ORDER BY timestamp_assigned DESC) AS rn
